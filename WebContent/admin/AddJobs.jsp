	...
	<table border="0" width="950" height="350" bgcolor="#ffffff"
		...
		<tr>
			<td align="center" valign="top">
				<form method="post" action="${pageContext.request.contextPath }/AddJobsServlet">
